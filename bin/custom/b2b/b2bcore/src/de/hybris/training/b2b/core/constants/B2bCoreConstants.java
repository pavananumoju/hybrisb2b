 ...
 */
package de.hybris.training.b2b.core.constants;

/**
 * Global class for all B2bCore constants. You can add global constants for your extension into this class.
 */
public final class B2bCoreConstants extends GeneratedB2bCoreConstants
{
	public static final String EXTENSIONNAME = "b2bcore";


	private B2bCoreConstants()
	{
		//empty
	}
