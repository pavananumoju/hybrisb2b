 ...
 */
package de.hybris.training.b2b.cockpits.setup;
...
import de.hybris.training.b2b.cockpits.constants.B2bCockpitsConstants;
 ...
 */
@SystemSetup(extension = B2bCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(B2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(B2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						B2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/b2bcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
