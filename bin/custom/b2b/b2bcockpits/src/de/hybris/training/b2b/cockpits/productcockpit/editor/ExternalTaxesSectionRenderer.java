 ...
 */
package de.hybris.training.b2b.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("b2bcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("b2bcockpits.product.externalTaxes"));
