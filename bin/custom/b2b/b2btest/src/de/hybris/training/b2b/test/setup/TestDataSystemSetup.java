 ...
 */
package de.hybris.training.b2b.test.setup;
...
import de.hybris.training.b2b.test.constants.B2bTestConstants;
import de.hybris.training.b2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = B2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/b2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/b2btest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/b2btest/import/cstickets.impex");
			...
			importImpexFile(context, "/b2btest/import/csquotes.impex");
		}
	}
}
