 ...
 */
package de.hybris.training.b2b.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, B2bFulfilmentProcessConstants.PARENT_PROCESS);
