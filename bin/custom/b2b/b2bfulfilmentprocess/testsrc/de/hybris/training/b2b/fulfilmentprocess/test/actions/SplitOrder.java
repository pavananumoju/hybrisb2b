 ...
 */
package de.hybris.training.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(B2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(B2bFulfilmentProcessConstants.PARENT_PROCESS);
